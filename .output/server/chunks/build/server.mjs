...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-Dv6NcoXP.mjs').then((m) => m.default || m)
  },
  {
    name: "Features",
    path: "/Features",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-BUqEIC-A.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-C-CcwT98.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./default-Chfwawuo.mjs').then((m) => m.default || m)
};
