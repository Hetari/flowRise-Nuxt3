...
import { u as usersCommunity } from './index-CjlUqRNy.mjs';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><p id="comment" class="translate-y-16 opacity-0">&quot;${ssrInterpolate(_ctx.user.comment)}&quot;</p><div id="comment-author" class="flex items-center gap-4 mt-8 translate-y-16 opacity-0"><img${ssrRenderAttr("src", _ctx.user.image)}${ssrRenderAttr("alt", _ctx.user.name)} class="size-10 rounded-full"><div><h3 class="text-body-small !font-semibold">${ssrInterpolate(_ctx.user.name)}</h3><p class="text-body-small text-[#6F6F6F]">${ssrInterpolate(_ctx.user.jobTitle)}</p></div></div></div>`);
    };
  }
});
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UserCard = _sfc_main$3;
      _push(`<section${ssrRenderAttrs(mergeProps({
        class: "space-y-8 max-w-[1400px] m-auto opacity-0 translate-y-20",
        id: "users-said"
      }, _attrs))}><h2 class="text-body-normal text-center">What our users say</h2><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10"><!--[-->`);
      ssrRenderList(unref(usersCommunity), (user) => {
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/UsersSaid.vue");
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<button${ssrRenderAttrs(mergeProps({
    type: "submit",
    class: "bg-secondary text-white py-3 px-10 text-[16px] rounded-full hover:bg-primary hover:scale-105 hover:shadow-lg transition-[background-color|scale|shadow] duration-300"
  }, _attrs))}> Try for free </button>`);
}
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "max-w-[1400px] m-auto md:px-12 px-4 py-12 grid place-items-center rounded-lg bg-gradient-to-tr from-cyan-50 via-white to-emerald-50 shadow-xl space-y-5" }, _attrs))}><h3>Unleash your inner productivity</h3><p>Sync your tasks and wellness to your unique rhythm.</p>`);
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/TryIt.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { ScrollTrigger as S, _sfc_main$2 as _, __nuxt_component_4 as a, __nuxt_component_0 as b };
//# sourceMappingURL=TryIt-DgbvDCK7.mjs.map
